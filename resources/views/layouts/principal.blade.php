...
{{--                    </li>--}}
                    ...
                    <li class="submenu">
                        <a href="#" ><i class="la la-user"></i> <span> Mantenimiento</span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            <li><a href="{{ route('principal.modulo') }}">Modulo</a></li>
                            <li><a href="{{ route('principal.menu') }}">Menu</a></li>
